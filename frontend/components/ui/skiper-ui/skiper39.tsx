...
import FileRequestNotifier from "@/components/FileRequestNotifier";
...
const Skiper39 = () => {
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden bg-[#020617] text-white">
      <FileRequestNotifier />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.14),_transparent_30%),radial-gradient(circle_at_bottom_right,_rgba(168,85,247,0.12),_transparent_25%)]" />
      <div className="absolute inset-x-0 top-24 z-20 px-4">
        <div className="mx-auto grid w-full max-w-[760px] justify-items-center gap-4 text-center text-white">
          <div className="relative flex flex-col items-center justify-center gap-3">
            <img
              src="/images/osintlogo.png"
              alt="OSINT logo"
              className="mx-auto max-h-20 object-contain"
            />
            <p className="text-xs uppercase tracking-[0.35em] text-cyan-300/80 sm:text-sm">
